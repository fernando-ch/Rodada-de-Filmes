...
var $author$project$Main$StepLogin = {$: 'StepLogin'};
...
var $author$project$Main$StepRecommendation = {$: 'StepRecommendation'};
...
var $author$project$Main$Person = F2(
	function (id, name) {
...
var $author$project$Main$personDecoder = A3(
	...
	return $elm$http$Http$get(
		{
			expect: A2(
				...
				$author$project$Main$personDecoder),
	...
	function (message, model) {
		switch (message.$) {
			...
			case 'Login':
				return _Utils_Tuple2(
					model,
					$author$project$Main$fetchPerson(model.formLogin));
			default:
				var response = message.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentStep: $author$project$Main$StepRecommendation, person: response}),
					$elm$core$Platform$Cmd$none);
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('pure-button pure-input-1 pure-button-primary')
					]),
				_List_fromArray(
					[
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				{currentStep: $author$project$Main$StepLogin, formLogin: '', person: $krisajenkins$remotedata$RemoteData$NotAsked},
				$elm$core$Platform$Cmd$none);
		},
