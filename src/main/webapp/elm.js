...
var $author$project$Movie$personSawBeforeRound = F2(
	function (personId, movieToChoose) {
		var _v0 = A2(
...
var $author$project$Round$stepDecoder = A2(
...
var $author$project$Round$roundDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'step',
	$author$project$Round$stepDecoder,
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'current',
...
var $author$project$Movie$movieDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'id',
			$elm$json$Json$Decode$int,
			$elm$json$Json$Decode$succeed($author$project$Movie$Movie))));
var $author$project$Main$movieUrl = $author$project$Main$baseUrl + 'movies/';
...
var $author$project$Movie$visualizationDecoder = A3(
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'alreadySawBeforeRound',
		$elm$json$Json$Decode$bool,
		$elm$json$Json$Decode$succeed($author$project$Movie$Visualization)));
var $author$project$Movie$movieWithVisualizationDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'visualizations',
	$elm$json$Json$Decode$list($author$project$Movie$visualizationDecoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'title',
		$elm$json$Json$Decode$string,
		A3(
			...
			'id',
			$elm$json$Json$Decode$int,
			$elm$json$Json$Decode$succeed($author$project$Movie$MovieWithVisualization))));
...
var $author$project$Person$personDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'movie',
	$elm$json$Json$Decode$nullable($author$project$Movie$movieDecoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'name',
		$elm$json$Json$Decode$string,
...
var $author$project$Movie$maybe = function (encoder) {
	return A2(
...
var $author$project$Movie$movieToChooseEncoder = function (movieToChoose) {
...
var $author$project$Movie$moviesToChooseEncoder = function (moviesToChooses) {
	return A2($elm$json$Json$Encode$list, $author$project$Movie$movieToChooseEncoder, moviesToChooses);
};
...
var $author$project$Main$viewLoginForm = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('form-login'),
				$elm$html$Html$Events$onSubmit($author$project$Main$Login)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('input-login'),
						$elm$html$Html$Events$onInput($author$project$Main$SaveLogin),
...
var $author$project$Main$viewMoviesToSeeTable = function (movies) {
	return A2(
		$elm$html$Html$table,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$viewMovieWatchingPage = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
				...
				switch (_v0.$) {
					...
					case 1:
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Carregando recommendações')
								]));
					default:
...
var $author$project$Main$viewRecommendationForm = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('form-recommendation'),
						$elm$html$Html$Events$onSubmit($author$project$Main$SendMovie)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('input-recommendation'),
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Enviar Recomendação')
							]))
					]))
			]));
};
...
var $author$project$Main$viewRecommendationsChooseTable = F2(
	function (recommendations, person) {
		return A2(
			$elm$html$Html$table,
			_List_Nil,
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$map,
						$author$project$Main$viewRecommendationChoose(person),
						recommendations))
				]));
	});
var $author$project$Main$viewRecommendationsChoose = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick($author$project$Main$SendChooseMovies)
										]),
									_List_fromArray(
										[
		...
		_List_fromArray(
			[
				...
				switch (model.$) {
								...
								case 3:
									...
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												'Erro status' + $elm$core$String$fromInt(status))
											]));
								default:
									var string = error.a;
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Erro ' + string)
											]));
							}
						} else {
							return A2(
					...
					default:
						var moviesToSeeModel = model.a;
						return $author$project$Main$viewMovieWatchingPage(moviesToSeeModel);
				}
			}()
			]));
};
